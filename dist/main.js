...
storage.set = function (key, val) {
  ...
  var data = {
    'type': typeof val === 'undefined' ? 'undefined' : _typeof(val), 'val': val
  };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex__ = __webpack_require__(385);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_app__ = __webpack_require__(171);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_user__ = __webpack_require__(172);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__getters__ = __webpack_require__(170);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__store_index_js__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__router__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_vue__ = __webpack_require__(382);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_iview_dist_styles_iview_css__ = __webpack_require__(377);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_jquery__ = __webpack_require__(144);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_uploadBtn_vue__ = __webpack_require__(142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_uploadBtn_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__components_uploadBtn_vue__);
...
__WEBPACK_IMPORTED_MODULE_0_vue__["default"].prototype.$ = __WEBPACK_IMPORTED_MODULE_6_jquery___default.a;

__WEBPACK_IMPORTED_MODULE_0_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_1_vue_cropper___default.a);
__WEBPACK_IMPORTED_MODULE_0_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_7__components_uploadBtn_vue___default.a);
...
service.interceptors.request.use(function (config) {
	...
	if (__WEBPACK_IMPORTED_MODULE_2__store__["a" /* default */].getters.token) {
		...
		config.data['token'] = __WEBPACK_IMPORTED_MODULE_2__store__["a" /* default */].getters.token;
	}
	...
	var transformRequest = function transformRequest(data) {
		...
		for (var _key in data) {
			ret += encodeURIComponent(_key) + '=' + encodeURIComponent(data[_key]) + '&';
		}
		return ret;
	};
...
service.interceptors.response.use(function (response) {
	...
	if (response.status !== 200) {
		__WEBPACK_IMPORTED_MODULE_1_iview__["Message"].error({
			content: res.message,
			duration: 5
		});
		if (response.status === 401) {
			__WEBPACK_IMPORTED_MODULE_1_iview__["Message"].warning('登录失效，请重新登录');
			__WEBPACK_IMPORTED_MODULE_2__store__["a" /* default */].dispatch('LogOut').then(function () {
				location.href = "#/login";
			});
		}
		if (response.status == 403) {
			__WEBPACK_IMPORTED_MODULE_1_iview__["Message"].warning('Access-Control-Allow-Origin');
		}
		if (response.status === 500) {
			__WEBPACK_IMPORTED_MODULE_1_iview__["Message"].warning(response.data.data);
		}
	...
	if (error == "Error: Request failed with status code 401") {
		__WEBPACK_IMPORTED_MODULE_2__store__["a" /* default */].dispatch('LogOut').then(function () {
			__WEBPACK_IMPORTED_MODULE_1_iview__["Message"].warning(error);
			location.href = "#/login";
		});
		return;
	}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config_env__ = __webpack_require__(167);
...
/* harmony default export */ __webpack_exports__["a"] = (roots[__WEBPACK_IMPORTED_MODULE_0__config_env__["a" /* default */]]);
...
Component.options.__file = "/Users/ops/Desktop/workspace/admin-bz/src/components/uploadBtn.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] uploadBtn.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2fd38de8", Component.options)
  } else {
    hotAPI.reload("data-v-2fd38de8", Component.options)
  }
})()}
...
/* harmony export (immutable) */ __webpack_exports__["b"] = getMsgCode;
/* harmony export (immutable) */ __webpack_exports__["c"] = loginByTel;
...
/* 图形验证码 */
var imageSrc = __WEBPACK_IMPORTED_MODULE_1__libs_root__["a" /* default */].javacore;
/* 短信验证码 */
function getMsgCode(mobile, nonstr, value) {
    var data = {
        mobile: mobile,
        nonstr: nonstr,
        value: value
...
/* 登录 */
function loginByTel(mobile, code) {
    var data = {
        mobile: mobile,
        code: code
    };
...
var login = function login(resolve) {
    return __webpack_require__.e/* require */(12).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(395)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var dashboard = function dashboard(resolve) {
    return __webpack_require__.e/* require */(0).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(394)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};

var demo = function demo(resolve) {
    return __webpack_require__.e/* require */(2).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(393)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};

// 租户模块
var uiBase = function uiBase(resolve) {
    return __webpack_require__.e/* require */(17).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(412)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var uiGlobal = function uiGlobal(resolve) {
    return __webpack_require__.e/* require */(3).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(413)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var tenantUI = [{ path: '/uiConfig/base', meta: { title: '基础' }, name: "基础", component: uiBase }, { path: '/uiConfig/global', meta: { title: '全局' }, name: "全局", component: uiGlobal }];
var manageUser = function manageUser(resolve) {
    return __webpack_require__.e/* require */(6).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(414)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var tenantUser = [{ path: '/usermanage/user', meta: { title: '用户' }, name: "用户", component: manageUser }];
var groupSources = function groupSources(resolve) {
    return __webpack_require__.e/* require */(7).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(411)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var groupAgency = function groupAgency(resolve) {
    return __webpack_require__.e/* require */(8).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(410)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var tenantGroup = [{ path: '/group/sources', meta: { title: '渠道商' }, name: "渠道商", component: groupSources }, { path: '/group/agency', meta: { title: '代理' }, name: "代理", component: groupAgency }];

// 产品模块
// 电销
var commissionReward = function commissionReward(resolve) {
    return __webpack_require__.e/* require */(25).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(399)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var listAllocate = function listAllocate(resolve) {
    return __webpack_require__.e/* require */(9).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(404)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var productSale = [{ path: '/sale/commission', meta: { title: '佣金奖励' }, name: "佣金奖励", component: commissionReward }, { path: '/sale/allocate', meta: { title: '名单分配' }, name: "名单分配", component: listAllocate }];
// 车险
var commissionConfig = function commissionConfig(resolve) {
    return __webpack_require__.e/* require */(5).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(398)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var productInsur = [{ path: '/carcare/commission', meta: { title: '保险佣金配置' }, name: "保险佣金配置", component: commissionConfig }];
// 非车险
var insurProList = function insurProList(resolve) {
    return __webpack_require__.e/* require */(1).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(402)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
// const insurProEditer = (resolve) => require(['../views/products/insurProEditer.vue'], resolve);
var insurPro = [{ path: '/insur/insurProList', meta: { title: '产品列表' }, name: "产品列表", component: insurProList }];
// 钱包
var identityAudit = function identityAudit(resolve) {
    return __webpack_require__.e/* require */(10).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(400)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var chashOut = function chashOut(resolve) {
...
var productWallet = [{ path: '/wallet/identity', meta: { title: '身份审核管理' }, name: "身份审核管理", component: identityAudit }, { path: '/wallet/chashout', meta: { title: '提现申请' }, name: "提现申请", component: chashOut }];
// 支付
var overallconfig = function overallconfig(resolve) {
    return __webpack_require__.e/* require */(21).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(406)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var payConfig = function payConfig(resolve) {
    return __webpack_require__.e/* require */(20).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(407)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var productPay = [{ path: '/pay/overallconfig', meta: { title: '全局配置' }, name: '全局配置', component: overallconfig }, { path: '/pay/payconfig', meta: { title: '支付配置' }, name: "支付配置", component: payConfig }];
// 通知
var noticeConfig = function noticeConfig(resolve) {
    return __webpack_require__.e/* require */(22).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(405)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var saleNotice = function saleNotice(resolve) {
    return __webpack_require__.e/* require */(18).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(409)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var insurNotice = function insurNotice(resolve) {
    return __webpack_require__.e/* require */(24).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(401)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var payNotice = function payNotice(resolve) {
    return __webpack_require__.e/* require */(19).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(408)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var integrateNotice = function integrateNotice(resolve) {
    return __webpack_require__.e/* require */(23).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(403)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var cashOutNotice = function cashOutNotice(resolve) {
    return __webpack_require__.e/* require */(26).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(396)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var productNotice = [{ path: '/notice/noticeconfig', meta: { title: '通知设置' }, name: "通知设置", component: noticeConfig }, { path: '/notice/noticesale', meta: { title: '电销通知' }, name: "电销通知", component: saleNotice }, { path: '/notice/noticeinsur', meta: { title: '投保通知' }, name: "投保通知", component: insurNotice }, { path: '/notice/noticepay', meta: { title: '支付通知' }, name: "支付通知", component: payNotice }, { path: '/notice/noticeintegrate', meta: { title: '积分通知' }, name: "积分通知", component: integrateNotice }, { path: '/notice/noticecashout', meta: { title: '提现通知' }, name: "提现通知", component: cashOutNotice }];

// 第三方服务


// 结算模块
var moneyPayList = function moneyPayList(resolve) {
    return __webpack_require__.e/* require */(4).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(391)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var moneyPreYield = function moneyPreYield(resolve) {
    return __webpack_require__.e/* require */(13).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(392)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var moneyAccount = function moneyAccount(resolve) {
    return __webpack_require__.e/* require */(14).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(390)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var moneyManage = [{ path: '/money/moneypaylist', meta: { title: '已支付列表' }, name: "已支付列表", component: moneyPayList }, { path: '/money/moneypreyield', meta: { title: '预收益管理' }, name: "预收益管理", component: moneyPreYield }, { path: '/money/moneyaccount', meta: { title: '出账管理' }, name: "出账管理", component: moneyAccount }];
var checkingEntry = function checkingEntry(resolve) {
    return __webpack_require__.e/* require */(16).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(388)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var checkingOutput = function checkingOutput(resolve) {
    return __webpack_require__.e/* require */(15).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(389)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
var checking = [{ path: '/checking/checkingrntry', meta: { title: '收项' }, name: "收项", component: checkingEntry }, { path: '/checking/checkingoutput', meta: { title: '结项' }, name: "结项", component: checkingOutput }];

var routers = [{ // 用户界面配置 第一个路由配合导航条
    group: "租户模块",
    path: '/uiConfig',
    meta: { title: '用户界面配置' },
    name: "用户界面配置",
    ...
    children: checking
}, { path: '/', redirect: '/login' }, { path: '/login', meta: { title: '登录' }, component: login }, { path: '/demo', meta: { title: '示例' }, component: demo }];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__libs_util__ = __webpack_require__(168);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__libs_routers__ = __webpack_require__(147);
...
var router = new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
    // mode: 'history',
    routes: __WEBPACK_IMPORTED_MODULE_4__libs_routers__["a" /* default */]
});
...
var getters = {
  ...
  tid: function tid(state) {
    return state.user.tid;
  },
  subMenu: function subMenu(state) {
    return state.app.subMenu;
  }
};
...
var app = {
	...
	mutations: {
		SET_SUBMENU: function SET_SUBMENU(state, router) {
			state.subMenu = router;
		}
	},
	actions: {
		updateSubMenu: function updateSubMenu(_ref, router) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_login__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__libs_storage_js__ = __webpack_require__(98);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_iview__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_iview___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_iview__);
...
var user = {
		state: {
				mobile: __WEBPACK_IMPORTED_MODULE_1__libs_storage_js__["a" /* default */].get('Admin-Mobile'),
				token: __WEBPACK_IMPORTED_MODULE_1__libs_storage_js__["a" /* default */].get('Admin-Token'),
				agent: "",
				tid: ""
		},
		...
		mutations: {
				...
				SET_AGENT: function SET_AGENT(state, agent) {
						state.agent = agent;
				},
				SET_TID: function SET_TID(state, tid) {
						state.tid = tid;
				}
		},
		...
		actions: {
				// 手机登录
				LoginByTel: function LoginByTel(_ref, opt) {
						var commit = _ref.commit;

						return new Promise(function (resolve, reject) {
								__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__api_login__["c" /* loginByTel */])(opt.mobile, opt.code).then(function (res) {
										if (res.errCode != "10000") {
												__WEBPACK_IMPORTED_MODULE_2_iview__["Message"].error({
														content: res.data,
														duration: 5
												});
										} else {
												__WEBPACK_IMPORTED_MODULE_1__libs_storage_js__["a" /* default */].set('Admin-Token', res.data);
												__WEBPACK_IMPORTED_MODULE_1__libs_storage_js__["a" /* default */].set('Admin-Mobile', opt.mobile);
				...
				LogOut: function LogOut(_ref2) {
						...
						return new Promise(function (resolve, reject) {
								__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__api_login__["d" /* logOut */])().then(function (res) {
										if (res.errCode == 10000) {
												__WEBPACK_IMPORTED_MODULE_2_iview__["Message"].error({
														content: "你已退出登录",
														duration: 5
												});
												__WEBPACK_IMPORTED_MODULE_1__libs_storage_js__["a" /* default */].del('Admin-Token');
												__WEBPACK_IMPORTED_MODULE_1__libs_storage_js__["a" /* default */].del('Admin-Mobile');
												commit('SET_TOKEN', 0);
												commit('SET_MOBILE', "");
												resolve();
										} else {
				...
				getAgent: function getAgent(_ref3, agent) {
						var commit = _ref3.commit;

						commit('SET_AGENT', agent);
				},
				getTid: function getTid(_ref4, tid) {
...
var $export = __webpack_require__(0);
var invoke = __webpack_require__(56);
var partial = __webpack_require__(180);
...
Component.options.__file = "/Users/ops/Desktop/workspace/admin-bz/src/app.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c0af31ea", Component.options)
  } else {
    hotAPI.reload("data-v-c0af31ea", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "ivu-upload ivu-upload-select"
  }, [_c('input', {
    ...
    staticClass: "ivu-btn ivu-btn-info",
    attrs: {
      "type": "button"
    },
    on: {
  ...
  }), _vm._v(" "), _c('span', [_vm._v("上传文件")])])]), _vm._v(" "), (_vm.progress > 0) ? _c('Progress', {
    attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-2fd38de8", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-c0af31ea", module.exports)
  }
}
